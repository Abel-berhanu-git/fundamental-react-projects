...
// Add values to the set : Takes one single value and Adds it as-is
mySet.add(1);
mySet.add(2);
mySet.add(3);
...
```js
// ✅ new Set(iterable)
// Expects an iterable , Loops over it , Adds each item separately
const mySet = new Set(['lunch', 'breakfast', 'shakes', 'lunch']);
console.log(mySet); // Set(3) {'lunch', 'breakfast', 'shakes'}
